...
class MembraneSimulator:
    ...
    def __init__(self):
        ...
        self.cell_mesh = None
        self.D = np.matrix(((4 * self.ref_T * MembraneSimulator.d1 / MembraneSimulator.length ** 2, -0.05),
                            (+0.05, 4 * self.ref_T * MembraneSimulator.d2 / MembraneSimulator.length ** 2)))
    ...
    def compute_effective_diffusion(self):
        ...
        self.composed_diff_coef = fe.Constant(self.D)*outside + fe.Constant(self.eff_diff)*inside
